...
const BlueTwo = ({state}: tpProps): JSX.Element => {

  return (
    <nav className="nav-002">
            ...
            <li>
              <a href="#">
                <svg className="person">
                  <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#person"></use>
                </svg><span>About</span></a>
            </li>
            <li>
              <a href="#">
                <svg className="video-player">
                  <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#video-player"></use>
